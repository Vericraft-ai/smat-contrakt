...
import { VericraftNFT, VericraftNFT__factory } from "../typechain"
...
task("balance-of", "Gets the balance of MyNFTs for provided address")
    ...
    .setAction(async (taskArguments: TaskArguments) => {
        ...
        const myNft: VericraftNFT = VericraftNFT__factory.connect(taskArguments.myNft, provider)
        ...
        spinner.stop()
        console.log(
            `ℹ️  The balance of VericraftNFTs of the ${
                taskArguments.owner
